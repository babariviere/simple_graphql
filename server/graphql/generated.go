...
type QueryResolver interface {
	AllProjects(ctx context.Context) ([]project.Project, error)
	AllUsers(ctx context.Context) ([]user.User, error)
}
...
// nolint: vetshadow
func (ec *executionContext) _Project_id(ctx context.Context, field graphql.CollectedField, obj *project.Project) graphql.Marshaler {
...
// nolint: vetshadow
func (ec *executionContext) _Project_name(ctx context.Context, field graphql.CollectedField, obj *project.Project) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Project",
	...
	for i, field := range fields {
		...
		case "allProjects":
			...
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_allProjects(ctx, field)
				if out.Values[i] == graphql.Null {
					invalid = true
				}
				wg.Done()
		...
		case "allUsers":
			wg.Add(1)
			go func(i int, field graphql.CollectedField) {
				out.Values[i] = ec._Query_allUsers(ctx, field)
				if out.Values[i] == graphql.Null {
					invalid = true
				}
				wg.Done()
...
// nolint: vetshadow
func (ec *executionContext) _Query_allProjects(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Query",
	...
	for idx1 := range res {
		...
		f := func(idx1 int) {
			...
			arr1[idx1] = func() graphql.Marshaler {
				...
				return ec._Project(ctx, field.Selections, &res[idx1])
			}()
		}
		if isLen1 {
			f(idx1)
...
// nolint: vetshadow
func (ec *executionContext) _Query_allUsers(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object: "Query",
...
var parsedSchema = gqlparser.MustLoadSchema(
	&ast.Source{Name: "schema.graphql", Input: `type Project {
  id: ID!
  name: String!
}
